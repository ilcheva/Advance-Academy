...
function positiveNegativeProduct(a: number, b: number, c: number) {
    if (a === 0 || b === 0 || c === 0) {
        console.log('zero');
    } else if (a > 0) {
        if (b > 0) {
...
function biggestInt(a: number, b: number, c: number) {
    if (a >= b) {
        ...
        else if (b < c) console.log(c);
    }
}
biggestInt(4, 6, 6);
// Sort 3 real values in descending order using nested if statements.

function sortedNumDesc(a: number, b: number, c: number) {
    if (a < b) {
...
function greatestNum(a: number, b: number, c: number, d: number, e: number) {

    if (a > b && a > c && a > d && a > e) console.log(a);
    if (b > a && b > c && b > d && b > e) console.log(b);
    if (c > a && c > b && c > d && a > e) console.log(c);
...
function numberToString(a: number) {
    ...
    if (a > 999) {
        ...
        if (h > 0) {
            ...
            if (d > 1) {
                switch (d) {
                    case 2: dText = "twenty"; break;
                    case 3: dText = "thrirty"; break;
                    case 4: dText = "fourty"; break;
                    case 5: dText = "fifty"; break;
                    case 6: dText = "sixty"; break;
                    case 7: dText = "seventy"; break;
                    case 8: dText = "eighty"; break;
                    case 9: dText = "ninety"; break;
                    default: dText = " ";
                }
                switch (s) {
                    case 1: sText = "one"; break;
                    case 2: sText = "two"; break;
                    case 3: sText = "three"; break;
                    case 4: sText = "four"; break;
                    case 5: sText = "five"; break;
                    case 6: sText = "six"; break;
                    case 7: sText = "seven"; break;
                    case 8: sText = "eight"; break;
                    case 9: sText = "nine"; break;
                    default: sText = " ";
